...
#ifndef __MODIS2SCIDB_UTILS_HPP__
#define __MODIS2SCIDB_UTILS_HPP__
...
namespace modis2scidb
{
  ...
  //std::vector<band_info> parse_bands(const std::string& str);
...
#endif  // __MODIS2SCIDB_UTILS_HPP__
